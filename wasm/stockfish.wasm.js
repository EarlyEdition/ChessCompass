...
ENVIRONMENT_IS_NODE ? (scriptDirectory = __dirname + "/", read_ = function(e, r) {
    var t;
    return nodeFS = nodeFS || require("fs"), e = (nodePath = nodePath || require("path")).normalize(e), t = nodeFS.readFileSync(e), r ? t : t.toString()
...
function dynamicAlloc(e) {
    var r = HEAP32[DYNAMICTOP_PTR >> 2],
        t = r + e + 15 & -16;
    return t > _emscripten_get_heap_size() && abort(), HEAP32[DYNAMICTOP_PTR >> 2] = t, r
}
...
function allocate(e, r, t, n) {
    ...
    if (a = t == ALLOC_NONE ? n : [_malloc, stackAlloc, dynamicAlloc][t](Math.max(i, s ? 1 : r.length)), o) {
        var u;
        for (assert(0 == (3 & (n = a))), u = a + (-4 & i); n < u; n += 4) HEAP32[n >> 2] = 0;
    ...
    for (var l, c, d, f = 0; f < i;) {
        var m = e[f];
        0 !== (l = s || r[f]) ? ("i64" == l && (l = "i32"), setValue(a + f, m, l), d !== l && (c = getNativeTypeSize(l), d = l), f += c) : f++
    }
    return a
}
...
var DYNAMIC_BASE = 6352400,
    DYNAMICTOP_PTR = 1109312,
...
function abort(e) {
    throw Module.onAbort && Module.onAbort(e), out(e += ""), err(e), ABORT = !0, EXITSTATUS = 1, "abort(" + e + "). Build with -s ASSERTIONS=1 for more info."
}
    ...
    return function() {
        ...
        fetch(wasmBinaryFile, {
            ...
            return WebAssembly.instantiateStreaming(e, r).then(n, function(e) {
                err("wasm streaming compile failed: " + e), err("falling back to ArrayBuffer instantiation"), o(n)
            })
        })
    }(), {}
}
...
isDataURI(wasmBinaryFile) || (wasmBinaryFile = locateFile(wasmBinaryFile)), Module.asm = createWasm, __ATINIT__.push({
    func: function() {
        globalCtors()
    }
});
...
var PATH = {
                ...
                if (!e.input.length) {
                    ...
                    if (ENVIRONMENT_IS_NODE) {
                        var t = Buffer.alloc ? Buffer.alloc(256) : new Buffer(256),
                            n = 0;
                        try {
                            n = fs.readSync(process.stdin.fd, t, 0, 256, null)
                        } catch (e) {
        ...
        stream_ops: {
            ...
            mmap: function(e, r, t, n, o, i, a) {
                ...
                if (2 & a || l.buffer !== r && l.buffer !== r.buffer) {
                    (0 < o || o + n < e.node.usedBytes) && (l = l.subarray ? l.subarray(o, o + n) : Array.prototype.slice.call(l, o, o + n)), u = !0;
    ...
    IDBFS = {
        ...
        getLocalSet: function(e, r) {
            ...
            for (var i = FS.readdir(e.mountpoint).filter(n).map(o(e.mountpoint)); i.length;) {
                ...
                FS.isDir(a.mode) && i.push.apply(i, FS.readdir(s).filter(n).map(o(s))), t[s] = {
                    timestamp: a.mtime
                }
            }
            return r(null, {
    ...
    NODEFS = {
        ...
        convertNodeCode: function(e) {
            var r = e.code;
            return assert(r in ERRNO_CODES), ERRNO_CODES[r]
        },
        mount: function(e) {
    ...
    FS = {
        ...
        lookupPath: function(e, r) {
            ...
            if (8 < r.recurse_count) throw new FS.ErrnoError(32);
                ...
                if (i = FS.lookupNode(i, o[s]), a = PATH.join2(a, o[s]), FS.isMountpoint(i) && (!u || u && r.follow_mount) && (i = i.mounted.root), !u || r.follow)
                    for (var l = 0; FS.isLink(i.mode);) {
                        ...
                        if (a = PATH_FS.resolve(PATH.dirname(a), c), i = FS.lookupPath(a, {
                            ...
                            }).node, 40 < l++) throw new FS.ErrnoError(32)
                    }
            }
            return {
                path: a,
        ...
        rename: function(r, t) {
            ...
            if (!e || !n) throw new FS.ErrnoError(44);
            if (e.mount !== n.mount) throw new FS.ErrnoError(75);
            var u, l = FS.lookupNode(e, a),
            ...
            if (l !== u) {
                ...
                if (!e.node_ops.rename) throw new FS.ErrnoError(63);
        ...
        open: function(r, e, t, n, o) {
            ...
            if (FS.isChrdev(i.mode) && (e &= -513), 65536 & e && !FS.isDir(i.mode)) throw new FS.ErrnoError(54);
            if (!a) {
        ...
        write: function(r, e, t, n, o, i) {
            ...
            if (0 == (2097155 & r.flags)) throw new FS.ErrnoError(8);
            ...
            var a = void 0 !== o;
            if (a) {
                if (!r.seekable) throw new FS.ErrnoError(70)
            } else o = r.position;
            ...
            try {
                ...
                console.log("FS.trackingDelegate['onWriteToFile']('" + r.path + "') threw an exception: " + e.message)
            }
            return s
        },
        allocate: function(e, r, t) {
        ...
        createLazyFile: function(e, r, s, t, n) {
            ...
            if (o.prototype.get = function(e) {
                    ...
                    if (e.open("HEAD", s, !1), e.send(null), !(200 <= e.status && e.status < 300 || 304 === e.status)) throw new Error("Couldn't load " + s + ". Status: " + e.status);
                    ...
                    a.setDataGetter(function(e) {
                        var r = e * i,
                            t = (e + 1) * i - 1;
                        if (t = Math.min(t, n - 1), void 0 === a.chunks[e] && (a.chunks[e] = function(e, r) {
                                ...
                                if (t.open("GET", s, !1), n !== i && t.setRequestHeader("Range", "bytes=" + e + "-" + r), "undefined" != typeof Uint8Array && (t.responseType = "arraybuffer"), t.overrideMimeType && t.overrideMimeType("text/plain; charset=x-user-defined"), t.send(null), !(200 <= t.status && t.status < 300 || 304 === t.status)) throw new Error("Couldn't load " + s + ". Status: " + t.status);
                                return void 0 !== t.response ? new Uint8Array(t.response || []) : intArrayFromString(t.responseText || "", !0)
                            }(r, t)), void 0 === a.chunks[e]) throw new Error("doXHR failed!");
                        return a.chunks[e]
                    }), !o && n || (i = n = 1, n = this.getter(0).length, i = n, console.log("LazyFiles on gzip forces download of the whole file when length is accessed")), this._length = n, this._chunkSize = i, this.lengthKnown = !0
        ...
        createPreloadedFile: function(o, i, e, a, s, u, l, c, d, f) {
            ...
            function r(r) {
                function t(e) {
                    f && f(), c || FS.createDataFile(o, i, e, a, s, d), u && u(), removeRunDependency(p)
                }
                var n = !1;
            ...
            addRunDependency(p), "string" == typeof e ? Browser.asyncLoad(e, function(e) {
                r(e)
            }, l) : r(e)
        },
        indexedDB: function() {
...
function ___syscall221(e, r) {
    ...
    try {
        ...
        switch (SYSCALLS.get()) {
            case 0:
                return (n = SYSCALLS.get()) < 0 ? -28 : FS.open(t.path, t.flags, 0, n).fd;
            case 1:
            case 2:
                return 0;
            case 3:
...
function _fd_seek(e, r, t, n, o) {
    try {
        var i = SYSCALLS.getStreamFromFD(e),
            a = 4294967296 * t + (r >>> 0),
            s = 9007199254740992;
        return a <= -s || s <= a ? -61 : (FS.llseek(i, a, n), tempI64 = [i.position >>> 0, (tempDouble = i.position, 1 <= +Math_abs(tempDouble) ? 0 < tempDouble ? (0 | Math_min(+Math_floor(tempDouble / 4294967296), 4294967295)) >>> 0 : ~~+Math_ceil((tempDouble - +(~~tempDouble >>> 0)) / 4294967296) >>> 0 : 0)], HEAP32[o >> 2] = tempI64[0], HEAP32[o + 4 >> 2] = tempI64[1], i.getdents && 0 == a && 0 === n && (i.getdents = null), 0)
    } catch (e) {
        return void 0 !== FS && e instanceof FS.ErrnoError || abort(e), e.errno
    }
}
    ...
    if (0 == e) Browser.mainLoop.scheduler = function() {
        ...
        if ("undefined" == typeof setImmediate) {
            ...
            addEventListener("message", function(e) {
                ...
                t.push(e), ENVIRONMENT_IS_WORKER ? (void 0 === Module.setImmediates && (Module.setImmediates = []), Module.setImmediates.push(e), postMessage({
                    target: n
                })) : postMessage(n, "*")
            }
        }
...
var Browser = {
    ...
    init: function() {
        if (Module.preloadPlugins || (Module.preloadPlugins = []), !Browser.initted) {
            ...
            var e = {
                ...
                handle: function(r, t, n, o) {
                    ...
                    s.onload = function() {
                        ...
                        e.width = s.width, e.height = s.height, e.getContext("2d").drawImage(s, 0, 0), Module.preloadedImages[t] = e, Browser.URLObject.revokeObjectURL(a), n && n(r)
            ...
            r.handle = function(r, t, n, e) {
                ...
                function a() {
                    o || (o = !0, Module.preloadedAudios[t] = new Audio, e && e())
                }
    ...
    requestFullScreen: function(e, r, t) {
        return err("Browser.requestFullScreen() is deprecated. Please call Browser.requestFullscreen instead."), Browser.requestFullScreen = function(e, r, t) {
    ...
    resumeAsyncCallbacks: function() {
        if (Browser.allowAsyncCallbacks = !0, 0 < Browser.queuedAsyncCallbacks.length) {
    ...
    asyncLoad: function(r, t, n, e) {
        ...
        readAsync(r, function(e) {
            assert(e, 'Loading data file "' + r + '" failed (no arrayBuffer).'), t(new Uint8Array(e)), o && removeRunDependency(o)
        }, function(e) {
...
function _emscripten_async_call(e, r, t) {
    ...
    noExitRuntime = !0, 0 <= t ? Browser.safeSetTimeout(n, t) : Browser.safeRequestAnimationFrame(n)
}
...
function _strftime(e, r, t, n) {
    ...
    function S(e) {
        var r = __addDays(new Date(e.tm_year + 1900, 0, 1), e.tm_yday),
            ...
            o = p(t),
            i = p(n);
        return m(o, r) <= 0 ? m(i, r) <= 0 ? r.getFullYear() + 1 : r.getFullYear() : r.getFullYear() - 1
    }
    var E = {
        "%a": function(e) {
        ...
        "%V": function(e) {
            ...
            return m(a, o) < 0 ? "53" : m(i, a) <= 0 ? "01" : (r = o.getFullYear() < e.tm_year + 1900 ? e.tm_yday + 32 - o.getDate() : e.tm_yday + 1 - o.getDate(), f(Math.ceil(r / 7), 2))
        },
        "%w": function(e) {
            return e.tm_wday
        },
    ...
    for (var u in E) 0 <= a.indexOf(u) && (a = a.replace(new RegExp(u, "g"), E[u](i)));
...
var asmGlobalArg = {},
    asmLibraryArg = {
        ...
        e: _llvm_stacksave,
        B: _pthread_attr_init,
        A: _pthread_attr_setstacksize,
        z: _pthread_cond_destroy,
        y: _pthread_create,
        x: _pthread_join,
        w: _strftime_l,
        b: abort,
...
Module.asm = asm;
var calledRun, __ZSt18uncaught_exceptionv = Module.__ZSt18uncaught_exceptionv = function() {
...
function run(e) {
    ...
    e = e || arguments_, 0 < runDependencies || (preRun(), 0 < runDependencies || (Module.setStatus ? (Module.setStatus("Running..."), setTimeout(function() {
        setTimeout(function() {
            Module.setStatus("")
        }, 1), r()
    }, 1)) : r()))
...
function exit(e, r) {
    r && noExitRuntime && 0 === e || (noExitRuntime || (ABORT = !0, EXITSTATUS = e, exitRuntime(), Module.onExit && Module.onExit(e)), quit_(e, new ExitStatus(e)))
}
